...
function saveData() {
    ...
    var uploadPath = dir + "/data/Subj"+ data.participantId + "_session" + data.session + "_day" + settings.day + settings.version + ".JSON";
...
function loadSubjectData(){
    ...
    settings.day = document.getElementById("training_day").value;
